...
<p align="center">go-pkg-spider 一个相对智能、无需规则维护的通用新闻网站采集工具库。</p>
...
- **<big>`DetectDomain(domain string, timeout int, retry int) (*DomainRes, error)`</big>** 探测域名信息
